...
# These are generated by scripts/generate_preset_demos.py from hardcoded presets.
_DEMO_GENRE_MAP: dict[str, str] = {
    "techno": "preset-techno.mp4",
    "dark-techno": "preset-dark-techno.mp4",
    "melodic-techno": "preset-melodic-techno.mp4",
    "ambient": "preset-ambient.mp4",
    "dark-ambient": "preset-dark-ambient.mp4",
    "synthwave": "preset-synthwave.mp4",
    "house": "preset-house.mp4",
    "deep-house": "preset-deep-house.mp4",
    "psytrance": "preset-psytrance.mp4",
    "drum-and-bass": "preset-drum-and-bass.mp4",
    "industrial": "preset-industrial.mp4",
    "edm": "preset-edm.mp4",
    "classical": "preset-classical.mp4",
    "jazz": "preset-jazz.mp4",
}
_DEMO_DEFAULT = "preset-techno.mp4"
